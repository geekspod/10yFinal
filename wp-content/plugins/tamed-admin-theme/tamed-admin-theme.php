...
if( class_exists('tamed') ) {
  ...
  function tamed_style() {
    ...
    wp_enqueue_style('tamed-admin-theme-adminBar', plugins_url('css/tamed-adminBar.css', __FILE__));
  }
  ...
  function update_style() {
    ...
    if( $option_theme ){
      ...
      wp_enqueue_style('tamed-admin-theme-adminBar-' . $option_theme, plugins_url('css/tamed-adminBar-' . $option_theme . '.css', __FILE__));
    } else {
      wp_enqueue_style('tamed-admin-theme-default', plugins_url('css/tamed-default.css', __FILE__));
      wp_enqueue_style('tamed-admin-theme-adminBar-default', plugins_url('css/tamed-adminBar-default.css', __FILE__));
    }
  }
  ...
  /*
   * Add admin bar styling to frontend
   */
  if( get_option('tamed_bar_frontend') ){
    function adminBar_style() {
      $option_theme = get_option('tamed_theme', 'default');

      wp_enqueue_style('tamed-admin-theme-adminBar', plugins_url('css/tamed-adminBar.css', __FILE__));
      wp_enqueue_style('tamed-admin-theme-adminBar-frontend', plugins_url('css/tamed-adminBar-frontend.css', __FILE__));
    ...
    add_action('wp_head', 'adminBar_style');
  }
  ...
  if( get_option('tamed_color_1') || get_option('tamed_color_2') || get_option('tamed_color_3') || get_option('tamed_color_4') ){
    ...
    if( get_option('tamed_bar_frontend') ){
      add_action('wp_head', 'tamed_style_custom');
    }
  }
