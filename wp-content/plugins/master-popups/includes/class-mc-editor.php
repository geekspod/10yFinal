...
//        $return .= "<div class='mc-control'>";
//        $return .= "<span class='mc-icon-setting' data-action='alignment-left' title='" . esc_html__( 'Align left', 'masterpopups' ) . "'></span>";
//        $return .= "<span class='mc-icon-setting' data-action='alignment-center-x' title='" . esc_html__( 'Align center', 'masterpopups' ) . "'></span>";
//        $return .= "<span class='mc-icon-setting' data-action='alignment-right' title='" . esc_html__( 'Align right', 'masterpopups' ) . "'></span>";
//        $return .= "</div>";
//        $return .= "</div>";//.mc-fieldset
//        $return .= "<div class='mc-fieldset'>";
//        $return .= "<label class='mc-label'>Vertical alignment</label>";
//        $return .= "<div class='mc-control'>";
//        $return .= "<span class='mc-icon-setting' data-action='alignment-top' title='" . esc_html__( 'Align top', 'masterpopups' ) . "'></span>";
//        $return .= "<span class='mc-icon-setting' data-action='alignment-center-y' title='" . esc_html__( 'Align middle', 'masterpopups' ) . "'></span>";
//        $return .= "<span class='mc-icon-setting' data-action='alignment-bottom' title='" . esc_html__( 'Align bottom', 'masterpopups' ) . "'></span>";
//        $return .= "</div>";
//        $return .= "</div>";//.mc-fieldset
//        $return .= "<div class='mc-fieldset'>";
//        $return .= "<label class='mc-label'>Size</label>";
//        $return .= "<div class='mc-control'>";
//        $return .= "<span class='mc-icon-setting' data-action='full-width' title='" . esc_html__( 'Full width', 'masterpopups' ) . "'></span>";
//        $return .= "<span class='mc-icon-setting mc-disabled' data-action='default-width' title='" . esc_html__( 'Previous width', 'masterpopups' ) . "'></span>";
//        $return .= "<span class='mc-icon-setting' data-action='full-height' title='" . esc_html__( 'Full height', 'masterpopups' ) . "'></span>";
//        $return .= "<span class='mc-icon-setting mc-disabled' data-action='default-height' title='" . esc_html__( 'Previous height', 'masterpopups' ) . "'></span>";
//        $return .= "</div>";
//        $return .= "</div>";//.mc-fieldset
//
//        $return .= "</div>";//.mc-section
    ...
    */
    public function build_context_menu(){
        $items = array(
            ...
            array(
                'name' => __( 'Duplicate Element', 'masterpopups' ),
...
//            ),
            array(
                'name' => __( 'Remove Element', 'masterpopups' ),
                'icon' => 'xbox-icon xbox-icon-trash',
