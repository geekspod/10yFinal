window.MaxCanvasEditor = (function (document, window, $) {
  ...
  function Plugin(el, options) {
    ...
    _.$ctx_menu = _.$canvas_wrap.find('#mc-context-menu');
  ...
  Plugin.prototype = {
    ...
    element_events: function () {
      ...
      _.$canvas.on('contextmenu', '.mc-element', function (event) {
        ...
        _.$ctx_menu.css({top: event.pageY - offsetCanvas.top, left: event.pageX - offsetCanvas.left + 10});
      ...
      _.$canvas_wrap.on('click', '.mc-ctx-item-link', function (event) {
        ...
        switch ( action ){
          case 'duplicate-element':
            ...
            break;
          case 'remove-element':
            _.options.app.remove_element($selected_element);
            break;
          case 'copy-style':
    ...
    set_visibility_context_menu: function (visibility) {
      var _ = this;
      if( visibility ){
        _.$ctx_menu.css('display', 'block');
      } else {
        _.$ctx_menu.css('display', 'none');
      }
    }
