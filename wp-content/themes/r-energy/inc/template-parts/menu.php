...
class R_EnergyWp_Bootstrap_Navwalker extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        $classes[] = ($args->has_children) ? 'has-submenu menu-item--has-child' : '';
    ...
    public static function fallback($args)
    {
        if (current_user_can('edit_theme_options')) {
            echo '<li><a href="' . admin_url('nav-menus.php') . '">' . esc_html__('Add a menu', 'r-energy') . '</a></li>';
        }
    }
}
