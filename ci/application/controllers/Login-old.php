...
public function nayatel_value_statements_data(){
	...
	//echo "<pre>";print_r($checkbox);exit;
		...
		else
		{
			...
			redirect(base_url().'login/nayatel_value_statements');
		}
		...
		$this->load->view('login/nayatel_value_statements',$data);
...
public function personality_assessment_questions_data(){
	...
	//echo "<pre>";print_r($checkbox);exit;
			...
			//echo "<pre>";print_r($form_data);exit;
		   $questions_score_id= $this->Model_category->add_personality_assessment_questions_data($form_data);
		  // echo "<pre>";print_r($questions_score_id);exit;
			$questions_score = $this->Model_category->get_last_inserted_record($questions_score_id);
			...
			//echo "<pre>";print_r($data['grade']);exit;
			$success = 'Personality Assessment Questions are added successfully!';
			$this->session->set_flashdata('success',$success);
			$data['setting'] = $this->Model_common->all_setting();
			$data['sliders'] = $this->Model_common->all_slider('login');
			//$this->load->view('view_header',$data);
...
//echo "<pre>";print_r($checkbox);exit;
		...
		//echo "<pre>";print_r($form_data);exit;
	   $questions_score_id= $this->Model_category->add_personal_values_assessment_questions_data($form_data);
	  // echo "<pre>";print_r($questions_score_id);exit;
		$questions_score = $this->Model_category->get_last_inserted_record($questions_score_id);
...
//echo "<pre>";print_r($checkbox);exit;
		...
		//echo "<pre>";print_r($form_data);exit;
	   $questions_score_id= $this->Model_category->add_cultural_scan_questions($form_data);
	  // echo "<pre>";print_r($questions_score_id);exit;
		$questions_score = $this->Model_category->get_last_inserted_record($questions_score_id);
...
public function data_collection(){
		...
		if(isset($_POST['form2'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				//echo "<pre>";print_r($dashboard_data['email']);exit;
...
// 			$email_details 	 = $this->Model_user->check_data_collection($email);
...
// 	}	
	...
	//	echo "<pre>";print_r($code);exit;
    	...
    	$update = $this->Model_user->updatestatus($status,$code) ;
