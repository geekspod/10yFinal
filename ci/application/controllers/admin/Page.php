...
class Page extends CI_Controller 
{
	...
	//	echo "<pre>";print_r($data['page_home']);exit;
		$data['why_home'] = $this->Model_page->why_home();
		$data['why_us'] = $this->Model_page->why_us();
		$data['our_vision'] = $this->Model_page->our_vision();
		
		$data['qhr_numbers'] = $this->Model_page->qhr_numbers();
        //echo "<pre>";print_r($data['qhr_numbers']);exit;
	...
	public function update()
	{
		...
		if(isset($_POST['form_home_welcome'])) {
        	$form_data = array(
				'name'       => $_POST['home_welcome_title'],
				'content'        => $_POST['home_welcome_text'],
			
				'date_modified'=>$date_modified,
            );
           // echo "<pre>";print_r($form_data);exit;
        $result=	$this->Model_page->update_why_home($form_data);
...
// 		why us
 ...
 $date_modified=date('Y-m-d H:i:s');
		if(isset($_POST['why_us'])) {
        	$form_data = array(
				'name'       => $_POST['why_us_name'],
				'content'        => $_POST['why_us_content'],
			//	'home_welcome_status'      => $_POST['home_welcome_status'],
				'date_modified'=>$date_modified,
            );
           // echo "<pre>";print_r($form_data);exit;
        $result=	$this->Model_page->update_why_us($form_data);
         //echo "<pre>";print_r($result);exit;
        	$success = 'Home page welcome information is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
...
$date_modified=date('Y-m-d H:i:s');
		if(isset($_POST['our_vision'])) {
        	$form_data = array(
				'name'       => $_POST['our_vision_name'],
				'content'        => $_POST['our_vision_content'],
			//	'home_welcome_status'      => $_POST['home_welcome_status'],
				'date_modified'=>$date_modified,
            );
            //echo "<pre>";print_r($form_data);exit;
        $result=	$this->Model_page->update_our_vision($form_data);
         //echo "<pre>";print_r($result);exit;
        	$success = 'Home page welcome information is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
...
// 		4-qhr in numbers
	...
	$date_modified=date('Y-m-d H:i:s');
		if(isset($_POST['qhr_numbers'])) {
        	$form_data = array(
				'name'       => $_POST['qhr_numbers_name'],
				'content'        => $_POST['qhr_numbers_content'],
			//	'home_welcome_status'      => $_POST['home_welcome_status'],
				'date_modified'=>$date_modified,
            );
           // echo "<pre>";print_r($form_data);exit;
        $result=	$this->Model_page->update_qhr_numbers($form_data);
         //echo "<pre>";print_r($result);exit;
        	$success = 'Home page welcome information is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
