    ...
    color: white;">
			<div class="inner ">
				<div class="sg-heading" style="text-align:center; padding-bottom:20px; font-weight:bold;">
				...
				<div class="sgn-form">
					...
					<form role="form" method="post" action="<?php echo base_url() ; ?>login/access" class="loginform" id="loginform">
						...
						<div class="form-check">
							<span class="rem">
								<a href="<?php echo base_url() ; ?>register/selection">Signup</a>
							</span> | 
							<span class="rem">
						...
						<button type="submit" class="btn btn-primary sb-btn loginbtn" style=" width: 35%; font-size: 20px;margin-left: 130px;">Login</button>
					</form>
					<!--<div class="or">
						<p>or</p>
