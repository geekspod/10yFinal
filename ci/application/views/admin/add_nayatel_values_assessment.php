				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
							    <textarea id="textarea" type="text" class="form-control" name="name1" placeholder="Kindly enter nayatel values assessment question 1."></textarea>
...
<!-- 2nd -->
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name2" placeholder="Kindly enter nayatel values assessment question 2."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name3" placeholder="Kindly enter nayatel values assessment question 3."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name4" placeholder="Kindly enter nayatel values assessment question 4."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name5" placeholder="Kindly enter nayatel values assessment question 5."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name6" placeholder="Kindly enter nayatel values assessment question 6."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name7" placeholder="Kindly enter nayatel values assessment question 7."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name8" placeholder="Kindly enter nayatel values assessment question 8."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
							<textarea id="textarea" type="text" class="form-control" name="name9" placeholder="Kindly enter nayatel values assessment question 9."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
							<textarea id="textarea" type="text" class="form-control" name="name10" placeholder="Kindly enter nayatel values assessment question 10."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name11" placeholder="Kindly enter nayatel values assessment question 11."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name12" placeholder="Kindly enter nayatel values assessment question 12."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
							<textarea id="textarea" type="text" class="form-control" name="name13" placeholder="Kindly enter nayatel values assessment question 13."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name14" placeholder="Kindly enter nayatel values assessment question 14."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name15" placeholder="Kindly enter nayatel values assessment question 15."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name16" placeholder="Kindly enter nayatel values assessment question 16."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
  ...
  <div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
							<textarea id="textarea" type="text" class="form-control" name="name17" placeholder="Kindly enter nayatel values assessment question 17."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name18" placeholder="Kindly enter nayatel values assessment question 18."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name19" placeholder="Kindly enter nayatel values assessment question 19."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="textarea" type="text" class="form-control" name="name20" placeholder="Kindly enter nayatel values assessment question 20."></textarea>
							</div>
						</div>
						</div>
                            <!-- <div class="d-flex justify-content-center my-4">
