...
<section class="content-header">
	...
	<div class="content-header-right">
		...
		<a href="<?php echo base_url(); ?>admin/categories/edit_Work_personality_index_questions" class="btn btn-primary btn-sm">Edit All Work Personality Index Questions</a>
		</div>
</section>
            ...
            <tbody>
            	...
            	foreach ($Work_personality_index as $row) {
					...
					<tr>
                        ...
                        <td><?php echo $row['dimensions_name']; ?></td>
                          <td><?php echo $row['sub_categories_names']; ?></td>
	                    <td>
