					...
					<div class="box-body">
			            ...
			            <div class="col-sm-6">
			            	<select name="status" class="form-control select2">
			            		<option value="enable" <?php if($partner['status']=='enable') {echo 'selected';} ?>>Active</option>
			            		<option value="disable" <?php if($partner['status']=='disable') {echo 'selected';} ?>>Inactive</option>
			            	</select>
			            </div>
			        </div>
						<div class="form-group">
