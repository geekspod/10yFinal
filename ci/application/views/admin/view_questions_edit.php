	        ...
	        <div class="box box-info">
	            ...
	            <div class="box-body">
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-8">
	                        <textarea id="textarea" type="text" class="ckeditor" name="name" placeholder="Kindly enter cultural scan questions."><?php echo $questions['name']; ?></textarea>
	                    </div>
	                </div>
<!-- 
					<div class="box box-info">
...
<div class="box-body">
	<div class="form-group">
		<label for="" class="col-sm-2 control-label">Dimensions Name <span>*</span></label>
		<div class="col-sm-4">
			<input type="text" class="form-control" name="dimensions_name" value="<?php echo $questions['dimensions_name']; ?>">
		</div>
	</div> -->
