	        ...
	        <div class="box box-info">
	            ...
	            <div class="box-body">
	                <div class="form-group">
	                    ...
	                    <div class="col-sm-8">
	                         <textarea id="textarea" type="text" class="ckeditor" name="name" placeholder="Kindly enter personal values assessment question ."><?php echo $questions_assessment['name']; ?></textarea>
