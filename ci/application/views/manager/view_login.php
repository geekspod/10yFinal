...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
		...
		<?php echo form_open(base_url().'manager'); ?>
		...
		<?php echo "<br>";"<br>";?>
			<div class="form-check">
							<span class="rem">
								<a href="<?php echo base_url() ; ?>manager/Login/register">Signup</a>
							</span> | 
							<span class="rem">
								<a href="<?php echo base_url() ; ?>manager/forget_password">forget password?</a>
							</span>
						</div>
						<br>
